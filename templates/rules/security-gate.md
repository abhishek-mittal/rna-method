---
name: Security Gate
description: Security review checklist — mandatory checks before any code merges to main.
alwaysApply: false
triggerKeywords: [security, auth, credential, secret, vulnerability, PR, review]
---
