...
description: Documentation quality rules — content format, frontmatter, freshness, and link integrity.
alwaysApply: false
triggerKeywords: [docs, documentation, README, changelog, ADR, comment, JSDoc]
---
