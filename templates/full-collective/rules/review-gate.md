---
name: Review Gate
description: PR review process standards — description format, definition of done, and merge criteria.
alwaysApply: false
triggerKeywords: [PR, pull request, review, merge, definition of done]
---
